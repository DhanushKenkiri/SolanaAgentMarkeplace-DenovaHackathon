...
interface CatalogAgentDetailClientProps {
  agentId: string;
}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-[#1a1625] border border-white/10 rounded-2xl p-6 mb-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div 
                  key={i}
                  className="aspect-[4/3] bg-[#0d0a14] border border-white/10 rounded-xl flex flex-col items-center justify-center p-4 hover:border-white/20 transition-colors cursor-pointer group relative"
                >
          ...
          <div className="bg-[#1a1625] border border-white/10 rounded-2xl p-6 mb-6">
            ...
            <div className="flex gap-4">
              ...
              <a href={agent.endpoint} target="_blank" rel="noopener noreferrer" className="text-white hover:text-indigo-400 transition-colors underline underline-offset-4 flex items-center gap-1">
                API Endpoint
